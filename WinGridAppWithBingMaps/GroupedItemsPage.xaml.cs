...
namespace WinGridAppWithBingMaps
{
    ...
    public sealed partial class GroupedItemsPage : Page
    {
        ...
        // Directions button click event to load Directions Page
        private void btnMap_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(MapPage), null);
        }
        // Favourites button click event to load Favourites Page
        private void btnFavourites_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(FavPage2), null);
        }
    }
}