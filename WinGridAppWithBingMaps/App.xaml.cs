...
namespace WinGridAppWithBingMaps
{
    ...
    sealed partial class App : Application
    {
        ...
        // method to add menu items to the settings pane
        private void OnCommandsRequested(SettingsPane sender, SettingsPaneCommandsRequestedEventArgs e)
        {
            e.Request.ApplicationCommands.Add(new SettingsCommand(1, "Help Menu", OnCommand));
        }
        // method to load new info based on settingscommand number
        private void OnCommand(IUICommand command)
        {
            ...
            switch (id)
            {
                //load help panel
                case 1:
                    HelpPanel opacitySettingsFlyout = new HelpPanel();
